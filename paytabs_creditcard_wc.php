...
*     text-domain: paytabs-payment-gateway-woocommerce
*
********************************************************************************************************************************/
@session_start();
...
function wpdocs_load_textdomain() {
  load_plugin_textdomain( 'paytabs-payment-gateway-woocommerce', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' ); 
}
